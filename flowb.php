...
<input type="text" name="darilink" class="up" placeholder="https://casperhunter.com/upload.txt">&nbsp;<input type="text" name="namalink" class="up" size="3" placeholder="file.txt"><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #fff">
</form>';
echo "</table><br>";
